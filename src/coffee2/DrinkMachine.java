...
public class DrinkMachine {
	...
	public static void startIO() {
		...
		while (true) {
			try {
				/*
				 * I considered using a switch here for more readable code. Elected to have a
				 * dynamic drink menu so drinks can be added to addAllDrinks() and this loop
				 * would not have to be change. The decision to have slightly less readable code
				 * in favor of a dynamic menu was made upon my belief that easily modifiable
				 * code is incredibly important.
				 */
	...
	public static void display() {
		// The sample IO in the assignment appears to add a blank line after output, so
		// I included that.
